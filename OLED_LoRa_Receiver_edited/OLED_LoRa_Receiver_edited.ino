...
String buttonAPress = "button A pressed";
String buttonBPress = "button B pressed";
...
void cbk(int packetSize) {
  ...
  if(packet.equals(buttonAPress)){
    digitalWrite(ledPin, HIGH);
    //Serial.println("led on");
  }
  if(packet.equals(buttonBPress)){
...
void setup() {
   ...
   digitalWrite(ledPin, HIGH); // initialize LED on 
